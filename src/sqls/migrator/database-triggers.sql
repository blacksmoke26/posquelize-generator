...
--
-- @description Retrieves all user-defined triggers from the PostgreSQL database
-- @returns List of triggers with their schema, table, name, timing, event, function details, status, and definition
