...
--
-- @description Retrieves constraint information for a given table, including foreign key relationships and column defaults
-- @param string tableName The name of the table to query
-- @param string tableSchema The schema/namespace of the table to query
-- @returns {
