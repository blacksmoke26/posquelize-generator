...
--
-- @description Retrieves information about views and materialized views in PostgreSQL,
--              including schema, name, type, owner, definition, comment, and various statistics.
