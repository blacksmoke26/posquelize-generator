...
--
-- This query retrieves information about user-defined domains in PostgreSQL,
-- including the schema name, domain name, base type, and the full domain
-- definition as a CREATE DOMAIN statement. It excludes system schemas
-- (information_schema, pg_catalog, pg_toast) and orders the results by
